...
export const LearnerSchema = z.object({
  ...
  parents: z.array(ParentSchema).nullish(),
  gender: z.string().nullish(),
  gender_text: z.string().nullish(),
  status: z.string().nullish(),
  status_text: z.string().nullish(),
  invitation_id: z.string().nullish(),
...
export const SubjectSchema = z.object({
  ...
  teacher_count: z.number().nullish(),
...
export const ClassSchema = z.object({
  ...
  _id: z.string().nullish(),
  name: z.string().nullish(),
  capacity: z.number().nullish().default(40),
  current_learners: z.number().nullish().default(0),
  learnerCount: z.number().nullish(),
  utilization: z.string().nullish(),
  utilization_percentage: z.number().nullish(),
  class_teacher_id: z.string().nullish(),
  class_teacher_name: z.string().nullish(),
  classTeacher: z.string().nullish(),
  subject_teachers: z.any().nullish(),
  subjectTeachers: z.any().nullish(),
  grade_id: z.string().nullish(),
  gradeId: z.string().nullish(),
}).passthrough().transform(data => ({
  ...data,
...
export const GradeSchema = z.object({
  ...
  name: z.string().nullish(),
  level: z.any().nullish(),
  grade_level: z.any().nullish(),
  description: z.string().nullish(),
  order: z.number().nullish().default(0),
  total_classes: z.number().nullish(),
  totalClasses: z.number().nullish(),
  total_learners: z.number().nullish(),
  totalLearners: z.number().nullish(),
  stats: z.object({
    classes_count: z.number().nullish(),
    learners_count: z.number().nullish(),
    classesCount: z.number().nullish(),
    learnersCount: z.number().nullish(),
  }).nullish(),
  classes: z.array(ClassSchema).nullish(),
