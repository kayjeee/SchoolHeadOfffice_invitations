...
const FileUploadClassesfromclasses = ({ onDataParsed, selectedGrade, selectedSchool }) => {
  ...
  const handleFileUpload = () => {
    ...
    reader.onload = (e) => {
      ...
      // Add selectedSchool and selectedGrade to each item
      const processedData = json.map(item => ({
        ...item,
        schoolname: selectedSchool,
        gradeId: selectedGrade ? selectedGrade._id.toString() : null
      }));
...
export default FileUploadClassesfromclasses;
