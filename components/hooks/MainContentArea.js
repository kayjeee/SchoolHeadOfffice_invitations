...
export default function MainContentArea({
  ...
  loggedInUser, // Assume this prop contains the logged-in user's information
}) {
  useEffect(() => {
    console.log('Logged In User:',school ); // Log the logged-in user info
  ...
  return (
    <div className="col-span-2 p-4 bg-gray-200 flex flex-col overflow-y-auto" style={{ height: '500px' }}>
      <div className="detailinside-box-container bg-white rounded-lg shadow-md p-6 mx-auto max-w-2xl h-96 overflow-y-auto w-full">
