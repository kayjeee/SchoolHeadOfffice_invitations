...
export const CopyButton: React.FC<CopyButtonProps> = ({
  ...
  const baseStyles = 'inline-flex items-center font-medium rounded transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1';
  const variantStyles = {
