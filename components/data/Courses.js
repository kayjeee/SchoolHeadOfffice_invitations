export const courses = [
 
    {
      ...
      category:'Need Funding,Bursaries, or Scholarships ?',
      reason:"SchoolHeadOffice has a list of all available bursaries",
      reasontwo: 'from schools around the country ',
      linkImg:
        '/BOARD done.png',
    },
    {
      id: 3,
      title: 'Have a Phone or laptop at home?',
      category:'SchoolHeadOffice Rewards Students for checking on their school rescources ',
      reason:"redeeem voucher and more",
     reasontwo: 'check if it applies to your school',
      linkImg:
        'resources folder pic.png',
    },
    {
      id: 4,
